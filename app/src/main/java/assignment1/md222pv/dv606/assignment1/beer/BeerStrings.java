...
/**
 * Created by damma on 06.09.2016.
 */
public enum BeerStrings {
    ZERO {
        public String getTitle() {
            return "Mornin' Delight";
        }

        public String toString() {
            return "Name: Mornin' Delight\n" +
                    "Rating: 4.7\n" +
    ...
    TWO {
        public String getTitle() {
            return "Pliny The Younger";
        }

        public String toString() {
            return "Name: Pliny The Younger\n" +
                    "Rating: 4.68\n" +
    ...
    FOUR {
        public String getTitle() {
            return "Kentucky Brunch Brand Stout";
        }

        public String toString() {
            return "Name: Kentucky Brunch Brand Stout\n" +
                    "Rating: 4.66\n" +
                    "Brewery: Toppling Goliath Brewing Company, Iowa, United States\n" +
                    "Style: American Double / Imperial Stout\n" +
                    "ABV: 12.00%\n" +
    ...
    FIVE {
        public String getTitle() {
            return "Pliny The Elder";
        }

        public String toString() {
            return "Name: Pliny The Elder\n" +
                    "Rating: 4.59\n" +
                    "Style: American Double / Imperial IPA\n" +
    ...
    SIX {
        public String getTitle() {
            return "Norrlands Guld Export";
        }

        public String toString() {
            return "Name: Norrlands Guld Export\n" +
                    "Rating: 2.62\n" +
